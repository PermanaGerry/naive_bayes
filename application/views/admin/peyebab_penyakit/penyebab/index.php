    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form id="create-penyebab" action="<?= base_url('admin/penyakit/penyebab-gejala/'.$penyakit->code).'/penyebab/save'; ?>"
              method="POST">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="check_list[]" value="<?= $penyebab->code; ?>">
                          </label>
                        </div>
                      </div>
                    </td>
          ...
          <div class="box-footer">
            ...
            onclick="event.preventDefault(); document.getElementById('create-penyebab').submit();">Submit</button>
            <a href="<?= base_url('admin/penyakit/penyebab-penyebab/'.$penyakit->code).'/penyebab'; ?>"

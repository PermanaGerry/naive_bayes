...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('gejala')?>">
                            <a href="<?php echo site_url('admin/gejala'); ?>">
                                <i class="fa fa-database"></i> <span><?php echo lang('menu_gejala'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('penyebab')?>">
                            <a href="<?php echo site_url('admin/penyebab'); ?>">
                                <i class="fa fa-database"></i> <span><?php echo lang('menu_penyebab'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('penyakit')?>">
                            <a href="<?php echo site_url('admin/penyakit'); ?>">
                                <i class="fa fa-database"></i> <span><?php echo lang('menu_penyakit'); ?></span>
                            </a>
                        </li>
